...
const SchoolOrders = () => {
  const orders = JSON.parse(localStorage.getItem('schoolOrders')) || [];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">School Bulk Orders</h1>
              <p className="text-gray-600">Track your school uniform orders</p>
            </div>
          </div>
          ...
          <div className="space-y-6">
            {orders.map((order) => (
              <div key={order.id} className="border border-gray-100 rounded-xl p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="font-medium text-gray-900">{order.school.name}</h3>
                    <p className="text-sm text-gray-500">{order.school.location}</p>
                  </div>
            ...
            {orders.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500">Your bulk orders will appear here</p>
              </div>
            )}
          </div>
        </div>
